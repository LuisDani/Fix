...
<div class="hidden sm:flex sm:items-center sm:ms-6">
    <x-dropdown align="right" width="48">
        ...
        <x-slot name="content">
            <!-- Perfil Link -->
            <x-dropdown-link :href="route('profile.show')" class="border-b border-gray-200">
                {{ __('Perfil') }}
            </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-500 space-y-1 divide-y divide-gray-200">
            <div class="px-4">
                <div class="font-bold text-base text-gray-950">{{ Auth::user()->name }}</div>
